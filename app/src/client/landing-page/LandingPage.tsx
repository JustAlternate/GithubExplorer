...
export default function LandingPage() {
  ...
  const NavLogo = () => <img className='h-8 w-8' src={logo} alt='Github Explorer App' />;
      ...
      <header className='absolute inset-x-0 top-0 z-50 dark:bg-boxdark-2'>
        <nav className='flex items-center justify-between p-6 lg:px-8' aria-label='Global'>
          <div className='flex items-center lg:flex-1'>
            ...
            >
              <NavLogo />
              <span className='ml-2 text-sm font-semibold leading-6 dark:text-white'>Github Explorer</span>
            </a>
          </div>
